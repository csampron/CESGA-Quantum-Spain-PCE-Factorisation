...
def plot_results(order_list, results, filename, ylim=None):
    ...
    plt.ylabel("Depth")
    plt.title("Resulting depth vs RSA size | DoTS Approach")
...
plot_results(
    ORDERS_FULL,
    results_full,
    os.path.join(output_dir, "1_Depth_Fact_DoTS_challenges.png"),
    550
)
...
plot_results(
    ORDERS_PARTIAL,
    results_partial,
    os.path.join(output_dir, "2_Depth_Fact_DoTS_challenges.png"),
    550
)
