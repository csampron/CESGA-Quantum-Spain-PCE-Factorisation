...
def plot_results(order_list, results, filename, ylim=None):
    ...
    plt.ylabel("Depth")
    plt.title("Resulting depth vs RSA size | Basic Approach")
...
plot_results(
    ORDERS_FULL,
    results_full,
    os.path.join(output_dir, "1_Depth_Fact_org_challenges.png")
)

plot_results(
    ORDERS_PARTIAL,
    results_partial,
    os.path.join(output_dir, "2_Depth_Fact_org_challenges.png")
)
