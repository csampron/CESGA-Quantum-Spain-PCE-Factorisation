...
def plot_results(order_list, results, filename, ylim=None):
    ...
    plt.ylabel("Params")
    plt.title("Params vs RSA size | Basic Approach")
...
plot_results(
    ORDERS_FULL,
    results_full,
    os.path.join(output_dir, "1_Params_Fact_org_challenges.png")
)

plot_results(
    ORDERS_PARTIAL,
    results_partial,
    os.path.join(output_dir, "2_Params_Fact_org_challenges.png")
)
